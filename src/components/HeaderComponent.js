...
import { Navbar, NavbarBrand, Nav, NavItem, NavbarToggler, Collapse, Button, Modal, ModalBody, ModalHeader, FormGroup, Input, Label, } from 'reactstrap';
                            ...
                            <FormGroup check>
                                <Label check>
                                    <Input type="checkbox" name="remember"
                                      innerRef={(input) => this.username = input} /> Remember me
                                </Label>
                            </FormGroup>
